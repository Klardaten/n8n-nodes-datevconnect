...
export class IndividualReference2ResourceHandler extends BaseResourceHandler {
	...
	private async getIndividualReferences2(authContext: AuthContext, sendSuccess: SendSuccessFunction): Promise<void> {
	...
	private async createIndividualReference2(authContext: AuthContext, sendSuccess: SendSuccessFunction): Promise<void> {
