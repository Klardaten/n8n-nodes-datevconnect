...
export type FetchIndividualPropertiesOptions =
...
export class DocumentManagementClient {
  ...
  static async authenticate(
    options: DocumentManagementAuthenticateOptions,
  ): Promise<DocumentManagementAuthenticateResponse> {
    return authenticate(
      options,
    ) as Promise<DocumentManagementAuthenticateResponse>;
  }
  ...
  static async fetchDocumentFile(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch document file: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async uploadDocumentFile(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to upload document file: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async fetchDocumentStates(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch document states: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async fetchDocumentState(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch document state: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async createDocumentState(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to create document state: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async deleteDocumentPermanently(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to permanently delete document: ${response.status} ${response.statusText}`,
      );
    }
  }
  ...
  static async fetchSecureAreas(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch secure areas: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async fetchPropertyTemplates(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch property templates: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async fetchIndividualProperties(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch individual properties: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async fetchIndividualReferences1(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch individual references 1: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async createIndividualReference1(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to create individual reference 1: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async fetchIndividualReferences2(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch individual references 2: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async createIndividualReference2(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to create individual reference 2: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async fetchStructureItems(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch structure items: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async fetchStructureItem(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to fetch structure item: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async addStructureItem(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to add structure item: ${response.status} ${response.statusText}`,
      );
    }
  ...
  static async updateStructureItem(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to update structure item: ${response.status} ${response.statusText}`,
      );
    }
    ...
    if (response.status === 204) {
      return {
        ...
        structureItemId: options.structureItemId,
      };
    }
  ...
  static async createDispatcherInformation(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to create dispatcher information: ${response.status} ${response.statusText}`,
      );
    }
